...
set_directive_loop_tripcount -min 4 -max 4 dense_layer/LOOP_RNN_O
set_directive_pipeline dense_layer/LOOP_RNN_I

set_directive_loop_tripcount -min 2 -max 2 dense_layer/LOOP_HIDUPDATE
set_directive_pipeline dense_layer/LOOP_HI
